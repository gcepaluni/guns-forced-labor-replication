...
# Focus: Municipal Capacity and “False-Lead” Tests
# Author: Gabriel Cepaluni
# Date:   2025-05-16
################################################################################
# PURPOSE:
#   Produces a unified LaTeX and HTML summary table replicating the reviewer’s
#   requested extensions. Focus on:
#     • Municipal capacity interactions (fiscal, security, or HDI proxies)
#     • “False-lead” validations: conditional hit-rate regressions (audited only)
#     • Baseline fixed effects and optional UF×Year specifications (LPM)
#
# DATA:
...
#   • Dynamically selects available capacity proxy (security, HDI, or revenue)
#   • Generates ASCII-safe, journal-ready LaTeX and HTML outputs
################################################################################
