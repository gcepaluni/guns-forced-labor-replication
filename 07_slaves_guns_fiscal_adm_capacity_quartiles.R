################################################################################
# REPLICATION PIPELINE — REVIEWER RESPONSE
# Focus: Municipal Capacity and “False-Lead” Diagnostics
# Author: Gabriel Cepaluni
# Date:   2025-05-16
################################################################################
# PURPOSE:
#   Generates a unified LaTeX and HTML summary table addressing the reviewer’s
#   extensions on enforcement heterogeneity. Specifically:
#     • Municipal capacity interactions (fiscal, security, or HDI proxies)
#     • “False-lead” diagnostics: conditional hit-rate regressions (audited only)
#     • Baseline FE and optional UF×Year specifications (LPM framework)
#
# DATA:
#   Input:  C:/Users/gabic/Dropbox/Slaves_Shif-Share_IV/WD_RR/WD_replication_files/Data/slavery_guns_census_panel.rds
#   Output: C:/Users/gabic/Dropbox/Slaves_Shif-Share_IV/WD_RR/WD_replication_files/Results
#
# MODELS:
#   Linear probability models (feols, clustered by municipality)
#   Outcomes: slavery cases, audits, and conditional hit rates
#
# OUTPUTS:
#   • main_results_summary.tex
#   • main_results_summary.html
#
# NOTES:
#   - Consistent FE labeling: Municipality, Year, UF×Year (where applicable)
#   - Automatically selects available capacity proxy (security, HDI, or revenue)
#   - Produces ASCII-safe, journal-ready LaTeX and HTML tables
################################################################################
