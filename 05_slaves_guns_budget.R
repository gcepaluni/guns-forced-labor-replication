...
# REPRODUCIBLE PIPELINE — BUDGET EXECUTION AND AFT APPOINTMENT TRENDS (2000–2025)
# Author: Gabriel Cepaluni
# Date:   2025-05-16
################################################################################
# PURPOSE:
#   Generates two harmonized figures for the World Development replication package:
#     (1) execution_ratios_trend.png   — Budget execution ratios (2019–2025)
#     (2) national_trend_appointments.png — Total AFT appointments (2000–2019)
#
# INPUTS:
#   - slavery_guns_budget_2000_2025.txt   (Budget for forced-labor inspection actions)
#   - AFT_99_a_2025_por_UF.csv            (AFT appointments by state and year)
#
# OUTPUTS:
...
#
# NOTES:
#   • Robust to separator types (comma/tab) and accented variable names
#   • Harmonized visual style: white panels, gray gridlines, consistent fonts
#   • Uses ASCII-safe names and dynamic column detection for cross-system portability
################################################################################
